...
final class Version20200831122438 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE cinema (id INT AUTO_INCREMENT NOT NULL, origin_id INT UNIQUE NOT NULL, title VARCHAR(255) DEFAULT NULL, category VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, description VARCHAR(5000) DEFAULT NULL, year INT, PRIMARY KEY(id))');
